...
//    public void selectAdminRole(String admin) throws InterruptedException {
//        log.info("Selecting Admin from Admin dropdown: " + selectAdmin.toString());
//        selectByVisibleTextFromDropDown(selectAdminDrop,admin);
//        Thread.sleep(1000);
        public void selectAdminRole(String Admin) {
            new Select(selectAdminDrop).selectByVisibleText(Admin);
        }
