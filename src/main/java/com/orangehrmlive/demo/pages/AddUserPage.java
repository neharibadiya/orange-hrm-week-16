...
public class AddUserPage extends Utility {
    ...
    public void enterUser() {
        ...
        sendTextToElement(enterUserName, "GautamPatel");
    }
    ...
    public void SelectStatusDisable(String Disable) throws InterruptedException {
        log.info("Selecting Status Disable: " + selectDisable.toString());
        selectByValueFromDropDown(statusSelect,Disable);
        Thread.sleep(1000);
